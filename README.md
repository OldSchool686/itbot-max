# IT_BOT — Система технической поддержки через MAX Messenger

Чат-бот для автоматизации IT-поддержки сотрудников компании. RAG на базе локальной LLM, веб-панель администратора и мобильное приложение с push-уведомлениями, возможна интеграция с Bitrix24
